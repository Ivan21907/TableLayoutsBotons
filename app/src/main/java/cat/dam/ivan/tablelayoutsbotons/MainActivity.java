package cat.dam.ivan.tablelayoutsbotons;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Button btn_lyt5 = findViewById(R.id.btn_lyt5);
        ...
        btn_lyt4.setOnClickListener(v -> {
            System.out.println("Button 4 Clicked");
            fl_content.removeAllViews();
            View child4 = getLayoutInflater().inflate(R.layout.layout4, null);
            fl_content.addView(child4);
        });
        btn_lyt5.setOnClickListener(v -> {
            System.out.println("Button 5 Clicked");
            fl_content.removeAllViews();
            View child5 = getLayoutInflater().inflate(R.layout.layout5, null);
            fl_content.addView(child5);
        });
